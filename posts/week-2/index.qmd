...
After optimizing the header extraction, we began building out a standalone `record.count()` function, mirroring the behavior found in [`grepreaper`](https://cran.r-project.org/web/packages/grepreaper/index.html){.external target="_blank"} package.
