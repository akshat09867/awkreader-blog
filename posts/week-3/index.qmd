...
## The AWK Lexicographical Comparison Trap
...
Looking at this complete structural breakdown, where the price column holds a coordinate value like 2757 and depth is loaded with characters (it seems logical to assume our row count would be broken too).

To verify, I ran a benchmark comparing our un-delimited tool against a native `data.table::fread()` operation:
